                ...
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    ...
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            <span class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 leading-5 rounded-md rounded-l-lg focus:outline-none focus:shadow-outline-purple cursor-pointer" aria-hidden="true">
                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_string($element))
                            <span aria-disabled="true">
                                <span class="relative inline-flex items-center px-4 py-2 -ml-px rounded-md rounded-l-lg focus:outline-none focus:shadow-outline-purple cursor-pointer">{{ $element }}</span>
                            </span>
                        @endif
