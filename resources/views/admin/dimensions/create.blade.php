<x-admin-layout pageTitle="Tambah Dimensi">
            ...
            <form action="{{ route('admin.dimensions.store') }}" method="POST">
                ...
                <label for="low_percentile_description" class="block text-sm my-2">
                    ...
                    <textarea
                        ...
                        value="{{ old('low_percentile_description') }}">{{ old('low_percentile_description') }}</textarea>
                ...
                <label for="high_percentile_description" class="block text-sm my-2">
                    ...
                    <textarea
                        ...
                        value="{{ old('high_percentile_description') }}">{{ old('high_percentile_description') }}</textarea>
