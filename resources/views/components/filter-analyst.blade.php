...
<form action="{{ $action }}" method="POST">
    ...
    <div class="bg-white w-full mb-4 p-6" x-data="{ showMoreFilter: true }">
        ...
        <div class="flex justify-end items-center w-full">
            <a href="{{ route('admin.analyst.pdf', request()->all()) }}" target="__blank" class="flex ml-auto mr-0 justify-center items-end space-x-2 px-4 mt-4 py-2 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
