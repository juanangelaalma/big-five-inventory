            ...
            <div class="flex flex-col justify-center col-span-1 text-center lg:text-start">
                <div class="flex items-center justify-center mb-4 lg:justify-normal">
                    <img class="h-5"
                        ...
                        alt="logo">
                    <h4 class="ml-2 text-sm font-bold tracking-widest text-primary uppercase">@lang('welcome.header.subtitle')</h4>
                </div>
                <h1 class="mb-8 text-4xl font-extrabold leading-tight lg:text-6xl text-dark-grey-900">@lang('welcome.header.title')</h1>
                <p class="mb-6 text-base font-normal leading-7 lg:w-3/4 text-grey-900">
                    @lang('welcome.header.description')
                </p>
                <div class="flex flex-col items-center gap-4 lg:flex-row">
                    <x-guest.primary-button href="{{ route('register') }}" class="lg:w-1/2 py-3">
                        @lang('welcome.header.cta.register')
