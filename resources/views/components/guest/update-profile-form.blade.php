<form method="post" action="{{ route('profile.update') }}" class="w-full" enctype="multipart/form-data">
    ...
    <div class="w-full flex flex-col-reverse lg:flex-row">
        <div class="w-full lg:w-1/2 lg:mt-6">
            <div>
                <x-text-input id="name" label="Nama" name="name" type="text" class="mt-1 block w-full"
            ...
            <div>
                <x-text-input id="student_number" label="NIM" name="student_number" type="text"
                    class="mt-1 block w-full" :value="old('student_number', avoidNullError($user->profile, 'student_number'))" autocomplete="student_number" />
            </div>
            ...
            <div>
                <x-text-input id="birth_date" label="Tanggal Lahir" name="birth_date" type="date"
                    class="mt-1 block w-full" :value="old('birth_date', avoidNullError($user->profile, 'birth_date'))" autocomplete="birth_date" />
            </div>
        ...
        <div class="w-full lg:w-1/2 lg:mt-6 flex justify-center">
            <x-profile-picture-input :image="avoidNullError($user->profile, 'profile_picture')" />
        </div>
